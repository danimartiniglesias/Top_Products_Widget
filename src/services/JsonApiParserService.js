class JsonApiParserService {
    // TODO generate JSON parser in es6 cool mode
    // To call it just import the clase JsonApiParserService.parse (JSONAPI)
}
...
export default JsonApiParserService;